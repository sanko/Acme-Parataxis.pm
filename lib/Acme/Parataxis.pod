...
and tokens (L<Acme::Parataxis::with_timeout|Acme::Parataxis::with_timeout> included) via the C<_join>
...
Every fiber that parks in a wait records where and why (wait_reason), and C<dump_fibers> exposes it: each live
