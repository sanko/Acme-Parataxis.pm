...
L<Wren|https://wren.io/concurrency.html> programming scripting language. It combines cooperative multitasking (fibers)
...
=item * B<Stack Limits:> Each fiber is allocated a 4MB stack. This is sufficient for most Perl code, but extremely
