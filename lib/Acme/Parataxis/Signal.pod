...
Unregister a fiber id or callback that is currently waiting on this signal. Returns the number of entries removed (0 or
1). Consumes nothing: a remembered signal is left untouched and no callback is invoked. Removed fibers must be
